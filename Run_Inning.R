...
#Simulating each of the 24 scenarios 1 million times
gameScenDF[1,2] <- gameScen(1000000, 000, 0)
gameScenDF[2,2] <- gameScen(1000000, 001, 0)
gameScenDF[3,2] <- gameScen(1000000, 010, 0)
gameScenDF[4,2] <- gameScen(1000000, 100, 0)
gameScenDF[5,2] <- gameScen(1000000, 011, 0)
gameScenDF[6,2] <- gameScen(1000000, 101, 0)
gameScenDF[7,2] <- gameScen(1000000, 110, 0)
gameScenDF[8,2] <- gameScen(1000000, 111, 0)
gameScenDF[1,4] <- gameScen(1000000, 000, 1)
gameScenDF[2,4] <- gameScen(1000000, 001, 1)
gameScenDF[3,4] <- gameScen(1000000, 010, 1)
gameScenDF[4,4] <- gameScen(1000000, 100, 1)
gameScenDF[5,4] <- gameScen(1000000, 011, 1)
gameScenDF[6,4] <- gameScen(1000000, 101, 1)
gameScenDF[7,4] <- gameScen(1000000, 110, 1)
gameScenDF[8,4] <- gameScen(1000000, 111, 1)
gameScenDF[1,6] <- gameScen(1000000, 000, 2)
gameScenDF[2,6] <- gameScen(1000000, 001, 2)
gameScenDF[3,6] <- gameScen(1000000, 010, 2)
gameScenDF[4,6] <- gameScen(1000000, 100, 2)
gameScenDF[5,6] <- gameScen(1000000, 011, 2)
gameScenDF[6,6] <- gameScen(1000000, 101, 2)
gameScenDF[7,6] <- gameScen(1000000, 110, 2)
gameScenDF[8,6] <- gameScen(1000000, 111, 2)
...
#Slope = 0.851 (should be closer to 1)
